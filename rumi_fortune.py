...
st.markdown("<p style='text-align: center; color: #e91e63;' font-size: 22px;'>🌟 おしゃべりBot 🌟</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; font-size: 18px;'>先生！今日もめちゃめちゃイケてますね✨</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; font-size: 18px;'>今日の運勢占ってみましょ？🔮</p><br>", unsafe_allow_html=True)
