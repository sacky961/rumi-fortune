...
st.markdown("<p style='text-align: center; font-size: 22px;'>先生！今日もめちゃめちゃイケてますね✨</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; font-size: 22px;'>今日の運勢占ってみましょ？🔮</p>", unsafe_allow_html=True)
