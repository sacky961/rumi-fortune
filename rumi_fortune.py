...
st.markdown("<h3 style='text-align: center;font-size: 22px;'>先生！今日もめちゃめちゃイケてますね✨</h3>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center;font-size: 22px;'>今日の運勢占ってみましょ？🔮</h3>", unsafe_allow_html=True)
