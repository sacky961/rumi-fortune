...
st.markdown("<h4 style='text-align: center;'>先生！今日もめちゃめちゃイケてますね✨</h4>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center;'>今日の運勢占ってみましょ？🔮</h4>", unsafe_allow_html=True)
